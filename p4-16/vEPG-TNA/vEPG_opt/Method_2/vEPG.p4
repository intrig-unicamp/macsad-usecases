...
/*********************************** gtp encap ****************************************/
    ...
    action set_enb_id(bit<16> enb_id)

    {
     meta.epg.enb_id = enb_id;
    }
...
Pipeline(// code is missing to follow the Barefoot SLACA terms & conditions) pipe;
